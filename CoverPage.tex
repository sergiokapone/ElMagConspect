	...
	%				                                         &                                                                                                                                   \\
		...
		\begin{flushleft}
			\begin{tabular}{lp{0.9\textwidth}}
				...
				П 563 & \hspace*{3ex} \realtitle : \subtitle{} [Електронний ресурс] : навчальний посібник / \authors{} --- К.:~КПІ ім. Ігоря Сікорського, 2024. --~\the\numexpr\getpagerefnumber{LastPage}-1\relax~с. -- Бібліогр.: с.~\pageref{BibPage}. \ifelectronic\relax\else-- 80~прим.\fi
			\end{tabular}
		\end{flushleft}
		\vfill
